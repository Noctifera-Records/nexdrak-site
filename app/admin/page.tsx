        ...
        <Card className="bg-card border-border">
          ...
          <CardContent className="space-y-3">
            <div className="grid grid-cols-2 gap-3">
              <a 
                href="/admin/music" 
                className="p-3 bg-muted hover:bg-muted/80 rounded-lg transition-colors text-center"
              >
                <Music className="h-5 w-5 mx-auto mb-2 text-green-500" />
                <p className="text-sm text-foreground">Add Music</p>
              </a>
              <a 
                href="/admin/merch" 
                className="p-3 bg-muted hover:bg-muted/80 rounded-lg transition-colors text-center"
              >
                ...
                <p className="text-sm text-foreground">Add Merch</p>
              </a>
              <a 
                href="/admin/events" 
                className="p-3 bg-muted hover:bg-muted/80 rounded-lg transition-colors text-center"
              >
                ...
                <p className="text-sm text-foreground">Add Event</p>
              </a>
              <a 
              ...
              >
                ...
                <p className="text-sm text-foreground">Add Download</p>
              </a>
            </div>
          </CardContent>
        </Card>
